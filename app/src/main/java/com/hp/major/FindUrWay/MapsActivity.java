...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etOrigin.setCompoundDrawablesWithIntrinsicBounds(R.drawable.start, 0, 0, 0);
        etOrigin.setCompoundDrawablePadding(15);
        etDestination.setCompoundDrawablesWithIntrinsicBounds(R.drawable.end, 0, 0, 0);
        etDestination.setCompoundDrawablePadding(15);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(28.644800, 77.216721);
